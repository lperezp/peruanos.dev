...
,
  ...
  },
  {
    ...
    {
        title: "OPEN DAY SECURITY INTERBANK",
        description: "Se viene un evento imperdible y totalmente GRATIS previo al #SecOpsDays2026. Gracias a una alianza exclusiva con Interbank, presentamos el OPEN DAY SECURITY INTERBANK. Un momento diseñado para que estudiantes, profesionales y apasionados de la tecnología conozcan desde adentro cómo se gestiona la seguridad digital en uno de los bancos más importantes del país. Ven a conectar con expertos del sector, hacer networking del más alto nivel y prepararte para el gran evento del año.",
        date: "2026-06-16",
        time: "18:00",
