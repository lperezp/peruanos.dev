        ...
        <>
            <header className="flex justify-between items-center h-[72px] bg-background px-8 shadow-[0_2px_10px_rgba(0,0,0,0.25)] z-[50] relative">
                ...
                <nav className="hidden md:flex items-center gap-7 text-foreground">
                    ...
                    <TrackedLink className="hover:text-primary transition-colors" href="/cfs" eventName="navigate_menu" eventParams={{ event_name: '/cfs', section: 'Header' }}>Call for Speakers</TrackedLink>
                ...
                <div className="hidden md:flex items-center gap-3 text-foreground">
                    ...
                    <Link
                        ...
                        className="hidden md:flex h-10 px-3 justify-center items-center rounded bg-background cursor-pointer border-none hover:bg-hover"
                ...
                {/* Mobile Menu Button */}
                <button
                    className="md:hidden h-10 w-10 flex justify-center items-center rounded bg-background cursor-pointer border-none hover:bg-hover"
                ...
                <div className="md:hidden fixed inset-0 top-[72px] bg-background z-40 px-8 py-6 shadow-lg">
                    <nav className="flex flex-col gap-6">
                        ...
                        <TrackedLink
                            ...
                            onClick={() => setIsMenuOpen(false)}
                            eventName="navigate_menu"
                            eventParams={{ event_name: '/cfs', section: 'Header' }}
                        >
                            Call for Speakers
                        </TrackedLink>
                        <TrackedLink
